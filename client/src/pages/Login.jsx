  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center h-screen'>
      <Form layout='vertical' onFinish={onFinishHandler} className='text-center border mx-10 md:mx-0 border-black w-full max-w-md p-8 rounded-lg shadow-md'>
        ...
        <button type='submit' className='rounded-md py-2 mx-[auto] w-40 lg:w-[20vw] bg-blue-400 text-white hover:bg-blue-800' >Login</button>
        <p>New User? <a href='/register' className='text-blue-400 hover:text-blue-800'>Register</a></p>
      </Form>
    </div>
    </>
  )
